...
for ns=1:numSNR
    ...
    for nf=1:numFrame
       ...
       %% ******************** 信道 *********************************************  
        ...
        h=(randn(1,1)+i*randn(1,1))/sqrt(2);
        DataModed=DataModed*h;
        DataModedwiHam=DataModedwiHam*h;
       ...
       %% ******************** 接收端 *********************************************     
        % ------------ demodulation---------------------
        BitDemoded=demodulation(Rdata./h,modLevel);
        BitDemodedwiHam=demodulation(RdatawiHam./h,modLevel);
        %-----------------decode-------------------------------
